...
if (!class_exists('Bachnguyen_Theme_Optionss')) {
    ...
    class Bachnguyen_Theme_Options
    {
        ...
        public function setSections()
        {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        'id' => 'talk_to_us',
                        'type' => 'text',
                        'title' => __('Talk to us', 'theme_option'),
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'id' => 'coming-in-from-out',
                        'type' => 'editor',
                        'title' => 'Coming in from out of town ?',
                        'desc' => 'Coming in from out of town ?'
                    ),
                    array(
                    ...
                    array(
                        ...
                        'type' => 'media',
                        'title' => __('Logo Footer', 'theme_option'),
            ...
            $this->sections[] = array(
                'title' => 'Social',
                'desc' => 'All of settings for social on this theme',
                'fields' => array(
                    array(
                    ...
                    array(
                        ...
                        'type' => 'text',
                        'title' => 'Page facebook',
                        'desc' => 'Face that you want to use on footer'
                    ),
